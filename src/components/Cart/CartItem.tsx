                  ...
                  <div key={item.code_product}>
                    <div className="productCart">
                      ...
                      <div className="productCart__remove">
                        <i
                          onClick={() =>
                            onPoCart({ type: "remove", data: item })
                          }
                          className="fa-solid fa-xmark fa-size"
                        />
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        Thông tin kèm theo :{" "}
                        {item.info_product && item.info_product.note}
                      </h5>
                      <h5
                        style={{
                          fontWeight: 500,
                      ...
                      >
                        Loại sản phẩm :{" "}
                        {item.info_product && item.info_product.type?.name}
                      </h5>
                    </div>
                  </div>
                );
