...
const ProductDetail = () => {
  ...
  const dataProductByShop = useAppSelector(
    selectProductSliceDataProductDetailShop
  );
  ...
  useEffect(() => {
    if (router.query.name) {
      ...
      dispatch(
        getProductByCodeOrName({
          code: arrNameRouter[1],
          name: arrNameRouter[0],
        })
      );
    }
          ...
          <div className="detail__content breadcrumb">
            ...
            <div
              className={`detail__content___product ${
                !loading && data ? "" : "productDetailLoading"
              }`}
            >
              <ProductDetailShow />
            </div>
        ...
        <div className="container">
          ...
          <div className="productAbout__product">
            <div className="productAbout__product___overScroll">
              {dataProductByShop.data &&
                dataProductByShop.data.data.map((item: any) => {
                  return (
                    <ProductItem
